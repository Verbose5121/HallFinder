...
// // Firebase storage reference, for image handling
// const storage = getStorage(app);

// // Database objects storage and retrieval
...
// // Updates current user on auth changes
// function useAuth() {
...
// // (wip) Alternate method for fetching user data
// // useAuth returns only the authentication user object, not the user collection data
// function UserData() {
