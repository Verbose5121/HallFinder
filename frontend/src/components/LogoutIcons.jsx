...
const LogoutIcons = ({ currentUser }) => {
  ...
  return (
    //   <div style={{display:"flex"}}><span style={{marginTop:"25px", marginRight:"10px", fontSize:"15px"}}>{currentUser=="undefined"?"":currentUser.displayName}</span>
    //  <a alt="Login" onClick={Logout} className="nav-item" style={{marginRight:"40px"}}><LogoutIcon fontSize="large"/></a></div>
